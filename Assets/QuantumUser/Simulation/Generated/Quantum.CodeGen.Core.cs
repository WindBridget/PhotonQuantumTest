...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Chicken : Quantum.IComponent {
    public const Int32 SIZE = 16;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
  ...
  public unsafe partial struct Health : Quantum.IComponent {
    ...
    [FieldOffset(16)]
    [ExcludeFromPrototype()]
    public FrameTimer DeathTimer;
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 2111;
        hash = hash * 31 + CurrentHealth.GetHashCode();
        hash = hash * 31 + MaxHealth.GetHashCode();
        hash = hash * 31 + DeathTime.GetHashCode();
        hash = hash * 31 + DeathTimer.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        FP.Serialize(&p->DeathTime, serializer);
        FrameTimer.Serialize(&p->DeathTimer, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct ShooterGameplay : Quantum.IComponentSingleton {
    public const Int32 SIZE = 4;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
    [ExcludeFromPrototype()]
    public PlayerRef BestHunter;
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 6287;
        hash = hash * 31 + BestHunter.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (ShooterGameplay*)ptr;
        PlayerRef.Serialize(&p->BestHunter, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct ShooterPlayer : Quantum.IComponent {
    public const Int32 SIZE = 4;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
    [ExcludeFromPrototype()]
    public Int32 ChickenKills;
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 6841;
        hash = hash * 31 + ChickenKills.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (ShooterPlayer*)ptr;
        serializer.Stream.Serialize(&p->ChickenKills);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Shooting : Quantum.IComponent {
    public const Int32 SIZE = 64;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + CameraPivotOffset.GetHashCode();
        hash = hash * 31 + CameraHandleOffset.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        FPVector3.Serialize(&p->CameraHandleOffset, serializer);
        FPVector3.Serialize(&p->CameraPivotOffset, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  public unsafe partial class Frame {
    ...
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentRemoved<Quantum.ShooterGameplay>();
      BuildSignalsArrayOnComponentAdded<Quantum.ShooterPlayer>();
      BuildSignalsArrayOnComponentRemoved<Quantum.ShooterPlayer>();
      BuildSignalsArrayOnComponentAdded<Quantum.Shooting>();
      BuildSignalsArrayOnComponentRemoved<Quantum.Shooting>();
    ...
    public unsafe partial struct FrameSignals {
      ...
      public void EntityKilled(EntityRef entity, EntityRef killerEntity) {
        ...
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.EntityKilled(_f, entity, killerEntity);
          }
        }
      }
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.ShooterGameplay), Quantum.ShooterGameplay.SIZE);
      typeRegistry.Register(typeof(Quantum.ShooterPlayer), Quantum.ShooterPlayer.SIZE);
      typeRegistry.Register(typeof(Quantum.Shooting), Quantum.Shooting.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 15)
        ...
        .Add<Quantum.Shooting>(Quantum.Shooting.Serialize, null, null, ComponentFlags.None)
