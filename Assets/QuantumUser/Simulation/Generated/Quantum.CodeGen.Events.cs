...
namespace Quantum {
    ...
    public unsafe partial struct FrameEvents {
      ...
      static partial void GetEventTypeCodeGen(Int32 eventID, ref System.Type result) {
        switch (eventID) {
          ...
          case EventFired.ID: result = typeof(EventFired); return;
      ...
      public EventFired Fired(EntityRef FireEntity, FPVector3 EndPosition, FPVector3 HitNormal, EntityRef HitEntity) {
        var ev = _f.Context.AcquireEvent<EventFired>(EventFired.ID);
        ev.FireEntity = FireEntity;
      ...
      public EventDamageReceived DamageReceived(EntityRef Entity) {
  ...
  public unsafe partial class EventFired : EventBase {
    public new const Int32 ID = 4;
    public EntityRef FireEntity;
    public FPVector3 EndPosition;
    public FPVector3 HitNormal;
    public EntityRef HitEntity;
    protected EventFired(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventFired() : 
    ...
    public override Int32 GetHashCode() {
      unchecked {
        var hash = 53;
        hash = hash * 31 + FireEntity.GetHashCode();
